...
class CartController extends GetxController implements GetxService {
  ...
  void updateIsOpenPartialPaymentPopupStatus(bool status,
      {bool shouldUpdate = true}) {
              ...
              Row(
                ...
                children: [
                  Icon(
                    ...
                    color: Theme.of(Get.context!).cardColor.withOpacity(0.6),
                    size: 16,
                  ),
                  const SizedBox(
  ...
  String maskNumberWithoutCountryCode(String phoneNumber) {
    ...
    String maskedNumber =
        phoneNumber.substring(0, phoneNumber.length - 6); // Keep initial digits
