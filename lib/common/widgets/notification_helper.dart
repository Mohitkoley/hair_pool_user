        ...
        if (payload.payload != null && payload.payload != '') {
          ...
          if (notificationBody.type == "chatting") {
            ...
            Get.toNamed(RouteHelper.getChatScreenRoute(
              ...
              notificationBody.type == 'bid-withdraw') {
