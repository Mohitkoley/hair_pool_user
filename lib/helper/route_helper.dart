...
class RouteHelper {
  ...
  static String getBookingDetailsScreen(
          String bookingID, String phone, String fromPage) =>
  ...
  static String getProviderReviewScreen(
          String subcategories, String providerId) =>
      '$providerReviewScreen?id=$providerId';
  static String getProviderAvailabilityScreen(
          String subcategories, String providerId) =>
  ...
  static List<GetPage> routes = [
    GetPage(
      ...
      // getRoute(ResponsiveHelper.isDesktop(Get.context)
    ...
    GetPage(
        ...
        page: () => getRoute(ProviderAvailabilityScreen(
